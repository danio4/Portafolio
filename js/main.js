    ...
    if ($('.home-page').length > 0) {
        if ($(window).width() > 768 && window.orientation !== 0) {
            ...
            let st3 = ScrollTrigger.create({
                trigger: "body",
                scrub:parseInt(scrubPower)/100,
                start: "-1 -" + (scrollDurationHome + projectBlocksScroll + addBlocksScroll*2),
                end: "+=" + (scrollDurationHome),
                onUpdate: ({progress, direction, isActive}) => {
                    if (progress >= 0.9) {
                        tlAvardsBtn.play();
            ...
            let st7 = ScrollTrigger.create({
                trigger: "body",
                scrub:parseInt(scrubPower)/100,
                start: "-1 -" + (scrollDurationHome * (sectionNumber - 1) + projectBlocksScroll + newsBlocksScroll + addBlocksScroll*4),
                end: "+=" + (scrollDurationHome),
                onToggle: ({progress, direction, isActive}) => {
                    if (!isActive && direction > 0) {
